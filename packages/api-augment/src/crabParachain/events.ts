...
import type { FrameSupportTokensMiscBalanceStatus, FrameSupportWeightsDispatchInfo, PalletMultisigTimepoint, SpRuntimeDispatchError, XcmV1MultiLocation, XcmV2Response, XcmV2TraitsError, XcmV2TraitsOutcome, XcmV2Xcm, XcmVersionedMultiAssets, XcmVersionedMultiLocation, CrabParachainRuntimeBridgesMessageCrabCrabParachainToCrabParameter, BpMessagesDeliveredMessages, PalletFeeMarketSlashReport, CrabParachainRuntimePalletsProxyProxyType } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  export interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    proxy: {
       ...
       **/
      AnonymousCreated: AugmentedEvent<ApiType, [AccountId32, AccountId32, CrabParachainRuntimePalletsProxyProxyType, u16]>;
      /**
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [AccountId32, AccountId32, CrabParachainRuntimePalletsProxyProxyType, u32]>;
      /**
