...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    bridgePangolinParachainMessages: {
       ...
       * event.
       **/
      updatePalletParameter: AugmentedSubmittable<(parameter: PangolinRuntimeBridgesMessagePangolinParachainPangolinToPangolinParachainParameter | { PangolinParachainToPangolinConversionRate: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PangolinRuntimeBridgesMessagePangolinParachainPangolinToPangolinParachainParameter]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    bridgePangoroMessages: {
       ...
       * event.
       **/
      updatePalletParameter: AugmentedSubmittable<(parameter: PangolinRuntimeBridgesMessagePangoroPangolinToPangoroMessagesParameter | { PangoroToPangolinConversionRate: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PangolinRuntimeBridgesMessagePangoroPangolinToPangoroMessagesParameter]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    multisig: {
       ...
       * # </weight>
       **/
      asMulti: AugmentedSubmittable<(threshold: u16 | AnyNumber | Uint8Array, otherSignatories: Vec<AccountId32> | (AccountId32 | string | Uint8Array)[], maybeTimepoint: Option<PalletMultisigTimepoint> | null | Uint8Array | PalletMultisigTimepoint | { height?: any; index?: any } | string, call: Bytes | string | Uint8Array, storeCall: bool | boolean | Uint8Array, maxWeight: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u16, Vec<AccountId32>, Option<PalletMultisigTimepoint>, Bytes, bool, u64]>;
      /**
    ...
    proxy: {
       ...
       * # </weight>
       **/
      addProxy: AugmentedSubmittable<(delegate: AccountId32 | string | Uint8Array, proxyType: PangolinRuntimePalletsProxyProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'EthereumBridge' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, PangolinRuntimePalletsProxyProxyType, u32]>;
      /**
       ...
       **/
      anonymous: AugmentedSubmittable<(proxyType: PangolinRuntimePalletsProxyProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'EthereumBridge' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [PangolinRuntimePalletsProxyProxyType, u32, u16]>;
      /**
       ...
       * # </weight>
       **/
      killAnonymous: AugmentedSubmittable<(spawner: AccountId32 | string | Uint8Array, proxyType: PangolinRuntimePalletsProxyProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'EthereumBridge' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, height: Compact<u32> | AnyNumber | Uint8Array, extIndex: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, PangolinRuntimePalletsProxyProxyType, u16, Compact<u32>, Compact<u32>]>;
      /**
       ...
       * # </weight>
       **/
      proxy: AugmentedSubmittable<(real: AccountId32 | string | Uint8Array, forceProxyType: Option<PangolinRuntimePalletsProxyProxyType> | null | Uint8Array | PangolinRuntimePalletsProxyProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'EthereumBridge' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, Option<PangolinRuntimePalletsProxyProxyType>, Call]>;
      /**
       ...
       * # </weight>
       **/
      proxyAnnounced: AugmentedSubmittable<(delegate: AccountId32 | string | Uint8Array, real: AccountId32 | string | Uint8Array, forceProxyType: Option<PangolinRuntimePalletsProxyProxyType> | null | Uint8Array | PangolinRuntimePalletsProxyProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'EthereumBridge' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, AccountId32, Option<PangolinRuntimePalletsProxyProxyType>, Call]>;
      /**
       ...
       * # </weight>
       **/
      removeProxy: AugmentedSubmittable<(delegate: AccountId32 | string | Uint8Array, proxyType: PangolinRuntimePalletsProxyProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'EthereumBridge' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, PangolinRuntimePalletsProxyProxyType, u32]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    session: {
       ...
       * # </weight>
       **/
      setKeys: AugmentedSubmittable<(keys: PangolinRuntimePalletsSessionSessionKeys | { babe?: any; grandpa?: any; beefy?: any; imOnline?: any; authorityDiscovery?: any } | string | Uint8Array, proof: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PangolinRuntimePalletsSessionSessionKeys, Bytes]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    system: {
       ...
       * # </weight>
       **/
      setChangesTrieConfig: AugmentedSubmittable<(changesTrieConfig: Option<SpCoreChangesTrieChangesTrieConfiguration> | null | Uint8Array | SpCoreChangesTrieChangesTrieConfiguration | { digestInterval?: any; digestLevels?: any } | string) => SubmittableExtrinsic<ApiType>, [Option<SpCoreChangesTrieChangesTrieConfiguration>]>;
      /**
    ...
    toPangolinParachainBacking: {
       ...
       **/
      lockAndRemoteIssue: AugmentedSubmittable<(specVersion: u32 | AnyNumber | Uint8Array, weight: u64 | AnyNumber | Uint8Array, value: Compact<u128> | AnyNumber | Uint8Array, fee: Compact<u128> | AnyNumber | Uint8Array, recipient: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u64, Compact<u128>, Compact<u128>, AccountId32]>;
       ...
       **/
      unlockFromRemote: AugmentedSubmittable<(amount: u128 | AnyNumber | Uint8Array, recipient: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, AccountId32]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
