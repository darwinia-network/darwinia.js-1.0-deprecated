...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    bridgePangolinParachainMessages: {
       ...
       **/
      ParameterUpdated: AugmentedEvent<ApiType, [PangolinRuntimeBridgesMessagePangolinParachainPangolinToPangolinParachainParameter]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    proxy: {
       ...
       **/
      AnonymousCreated: AugmentedEvent<ApiType, [anonymous: AccountId32, who: AccountId32, proxyType: PangolinRuntimePalletsProxyProxyType, disambiguationIndex: u16], { anonymous: AccountId32, who: AccountId32, proxyType: PangolinRuntimePalletsProxyProxyType, disambiguationIndex: u16 }>;
      /**
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: PangolinRuntimePalletsProxyProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: PangolinRuntimePalletsProxyProxyType, delay: u32 }>;
      /**
