...
import type { BpMessagesDeliveredMessages, FrameSupportTokensMiscBalanceStatus, FrameSupportWeightsDispatchInfo, PalletFeeMarketS2sPaymentRewardItem, PalletFeeMarketSlashReport, PalletMultisigTimepoint, PangolinParachainRuntimeBridgesMessagePangolinPangolinParachainToPangolinParameter, PangolinParachainRuntimePalletsProxyProxyType, SpRuntimeDispatchError, XcmV1MultiLocation, XcmV2Response, XcmV2TraitsError, XcmV2TraitsOutcome, XcmV2Xcm, XcmVersionedMultiAssets, XcmVersionedMultiLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    bridgePangolinMessages: {
       ...
       **/
      ParameterUpdated: AugmentedEvent<ApiType, [PangolinParachainRuntimeBridgesMessagePangolinPangolinParachainToPangolinParameter]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    proxy: {
       ...
       **/
      AnonymousCreated: AugmentedEvent<ApiType, [anonymous: AccountId32, who: AccountId32, proxyType: PangolinParachainRuntimePalletsProxyProxyType, disambiguationIndex: u16], { anonymous: AccountId32, who: AccountId32, proxyType: PangolinParachainRuntimePalletsProxyProxyType, disambiguationIndex: u16 }>;
      /**
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: PangolinParachainRuntimePalletsProxyProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: PangolinParachainRuntimePalletsProxyProxyType, delay: u32 }>;
      /**
       ...
       * A proxy was removed.
       **/
      ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: PangolinParachainRuntimePalletsProxyProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: PangolinParachainRuntimePalletsProxyProxyType, delay: u32 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
