...
import type { BpHeaderChainInitializationData, BpHeaderChainJustificationGrandpaJustification, BpMessageDispatchMessagePayload, BpMessagesOperatingMode, BpMessagesUnrewardedRelayersState, BridgeRuntimeCommonMessagesSourceFromBridgedChainMessagesDeliveryProof, BridgeRuntimeCommonMessagesTargetFromBridgedChainMessagesProof, CumulusPrimitivesParachainInherentParachainInherentData, PalletMultisigTimepoint, PangolinParachainRuntimeBridgesMessagePangolinPangolinParachainToPangolinParameter, PangolinParachainRuntimeOriginCaller, PangolinParachainRuntimePalletsProxyProxyType, PangolinParachainRuntimePalletsSessionSessionKeys, SpRuntimeHeader, XcmV1MultiLocation, XcmV2WeightLimit, XcmVersionedMultiAssets, XcmVersionedMultiLocation, XcmVersionedXcm } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    bridgePangolinMessages: {
       ...
       * event.
       **/
      updatePalletParameter: AugmentedSubmittable<(parameter: PangolinParachainRuntimeBridgesMessagePangolinPangolinParachainToPangolinParameter | { PangolinToPangolinParachainConversionRate: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PangolinParachainRuntimeBridgesMessagePangolinPangolinParachainToPangolinParameter]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    fromPangolinIssuing: {
      burnAndRemoteUnlock: AugmentedSubmittable<(specVersion: u32 | AnyNumber | Uint8Array, weight: u64 | AnyNumber | Uint8Array, value: Compact<u128> | AnyNumber | Uint8Array, fee: Compact<u128> | AnyNumber | Uint8Array, recipient: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u64, Compact<u128>, Compact<u128>, AccountId32]>;
      /**
       * Handle relay message sent from the source backing pallet with relay message
       **/
      issueFromRemote: AugmentedSubmittable<(value: u128 | AnyNumber | Uint8Array, recipient: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, AccountId32]>;
    ...
    proxy: {
       ...
       * # </weight>
       **/
      addProxy: AugmentedSubmittable<(delegate: AccountId32 | string | Uint8Array, proxyType: PangolinParachainRuntimePalletsProxyProxyType | 'Any' | 'NonTransfer' | 'CancelProxy' | 'Collator' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, PangolinParachainRuntimePalletsProxyProxyType, u32]>;
      /**
       ...
       **/
      anonymous: AugmentedSubmittable<(proxyType: PangolinParachainRuntimePalletsProxyProxyType | 'Any' | 'NonTransfer' | 'CancelProxy' | 'Collator' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [PangolinParachainRuntimePalletsProxyProxyType, u32, u16]>;
      /**
       ...
       * # </weight>
       **/
      proxy: AugmentedSubmittable<(real: AccountId32 | string | Uint8Array, forceProxyType: Option<PangolinParachainRuntimePalletsProxyProxyType> | null | Uint8Array | PangolinParachainRuntimePalletsProxyProxyType | 'Any' | 'NonTransfer' | 'CancelProxy' | 'Collator' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, Option<PangolinParachainRuntimePalletsProxyProxyType>, Call]>;
      /**
       ...
       * # </weight>
       **/
      proxyAnnounced: AugmentedSubmittable<(delegate: AccountId32 | string | Uint8Array, real: AccountId32 | string | Uint8Array, forceProxyType: Option<PangolinParachainRuntimePalletsProxyProxyType> | null | Uint8Array | PangolinParachainRuntimePalletsProxyProxyType | 'Any' | 'NonTransfer' | 'CancelProxy' | 'Collator' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, AccountId32, Option<PangolinParachainRuntimePalletsProxyProxyType>, Call]>;
      /**
    ...
    remoteGovernance: {
      emergencySafeguard: AugmentedSubmittable<(call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Call]>;
      /**
       * Handle relay message sent from the source backing pallet with relay message
       **/
      enactRemoteCall: AugmentedSubmittable<(call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Call]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    session: {
       ...
       * # </weight>
       **/
      setKeys: AugmentedSubmittable<(keys: PangolinParachainRuntimePalletsSessionSessionKeys | { aura?: any } | string | Uint8Array, proof: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PangolinParachainRuntimePalletsSessionSessionKeys, Bytes]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    utility: {
       ...
       * # </weight>
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: PangolinParachainRuntimeOriginCaller | { system: any } | { Void: any } | { PolkadotXcm: any } | { CumulusXcm: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PangolinParachainRuntimeOriginCaller, Call]>;
      /**
       * Send a batch of dispatch calls.
