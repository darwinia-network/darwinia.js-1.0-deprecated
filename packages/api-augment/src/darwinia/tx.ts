...
import type { PalletElectionProviderMultiPhaseRawSolution, PalletElectionProviderMultiPhaseSolutionOrSnapshotSize, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, PalletImOnlineHeartbeat, PalletImOnlineSr25519AppSr25519Signature, PalletMultisigTimepoint, PalletSocietyJudgement, SpConsensusBabeDigestsNextConfigDescriptor, SpConsensusSlotsEquivocationProof, SpFinalityGrandpaEquivocationProof, SpNposElectionsSupport, SpRuntimeHeader, SpSessionMembershipProof, BpHeaderChainInitializationData, BridgeRuntimeCommonMessagesTargetFromBridgedChainMessagesProof, BpHeaderChainJustificationGrandpaJustification, BridgeRuntimeCommonMessagesSourceFromBridgedChainMessagesDeliveryProof, BpMessagesUnrewardedRelayersState, BpMessageDispatchMessagePayload, BpMessagesOperatingMode, DarwiniaDemocracyConviction, DarwiniaRuntimeBridgesMessageCrabDarwiniaToCrabMessagesParameter, EthereumPrimitivesHeader, DarwiniaDemocracyVoteAccountVote, ToEthereumBackingRedeemFor, EthereumPrimitivesReceiptReceiptProof, DarwiniaBridgeEthereumMmrProof, DarwiniaRelayPrimitivesRelayerGameRelayAffirmationId, DarwiniaBridgeEthereumEthereumRelayHeaderParcel, DarwiniaBridgeEthereumEthereumRelayProofs, DarwiniaElectionsPhragmenRenouncing, DarwiniaStakingStructsStakingBalance, DarwiniaRuntimePalletsSessionSessionKeys, DarwiniaStakingStructsRewardDestination, SpCoreChangesTrieChangesTrieConfiguration, DarwiniaStakingStructsValidatorPrefs, DarwiniaVestingVestingInfo } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    proxy: {
       ...
       * # </weight>
       **/
      proxy: AugmentedSubmittable<(real: AccountId32 | string | Uint8Array, forceProxyType: Option<DarwiniaRuntimePalletsProxyProxyType> | null | object | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, Option<DarwiniaRuntimePalletsProxyProxyType>, Call]>;
      /**
       ...
       * # </weight>
       **/
      proxyAnnounced: AugmentedSubmittable<(delegate: AccountId32 | string | Uint8Array, real: AccountId32 | string | Uint8Array, forceProxyType: Option<DarwiniaRuntimePalletsProxyProxyType> | null | object | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, AccountId32, Option<DarwiniaRuntimePalletsProxyProxyType>, Call]>;
      /**
    ...
    scheduler: {
       ...
       * # </weight>
       **/
      schedule: AugmentedSubmittable<(when: u32 | AnyNumber | Uint8Array, maybePeriodic: Option<ITuple<[u32, u32]>> | null | object | string | Uint8Array, priority: u8 | AnyNumber | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, Option<ITuple<[u32, u32]>>, u8, Call]>;
      /**
       ...
       * # </weight>
       **/
      scheduleAfter: AugmentedSubmittable<(after: u32 | AnyNumber | Uint8Array, maybePeriodic: Option<ITuple<[u32, u32]>> | null | object | string | Uint8Array, priority: u8 | AnyNumber | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, Option<ITuple<[u32, u32]>>, u8, Call]>;
      /**
       ...
       * # </weight>
       **/
      scheduleNamed: AugmentedSubmittable<(id: Bytes | string | Uint8Array, when: u32 | AnyNumber | Uint8Array, maybePeriodic: Option<ITuple<[u32, u32]>> | null | object | string | Uint8Array, priority: u8 | AnyNumber | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, u32, Option<ITuple<[u32, u32]>>, u8, Call]>;
      /**
