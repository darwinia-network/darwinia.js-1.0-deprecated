...
import type { PalletElectionProviderMultiPhaseRawSolution, PalletElectionProviderMultiPhaseSolutionOrSnapshotSize, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, PalletImOnlineHeartbeat, PalletImOnlineSr25519AppSr25519Signature, PalletMultisigTimepoint, PalletSocietyJudgement, SpConsensusBabeDigestsNextConfigDescriptor, SpConsensusSlotsEquivocationProof, SpFinalityGrandpaEquivocationProof, SpNposElectionsSupport, SpRuntimeHeader, SpSessionMembershipProof,BpHeaderChainInitializationData,BpHeaderChainJustificationGrandpaJustification,BridgeRuntimeCommonMessagesSourceFromBridgedChainMessagesDeliveryProof,BpMessagesUnrewardedRelayersState,BridgeRuntimeCommonMessagesTargetFromBridgedChainMessagesProof,BpMessageDispatchMessagePayload,BpMessagesOperatingMode,DarwiniaDemocracyConviction,
  ToEthereumBackingRedeemFor,DarwiniaDemocracyVoteAccountVote,EthereumPrimitivesReceiptReceiptProof,DarwiniaBridgeEthereumMmrProof,EthereumPrimitivesHeader,
  DarwiniaRelayPrimitivesRelayerGameRelayAffirmationId,DarwiniaBridgeEthereumEthereumRelayProofs,
  DarwiniaBridgeEthereumEthereumRelayHeaderParcel,DarwiniaElectionsPhragmenRenouncing,
  DarwiniaRuntimePalletsSessionSessionKeys,DarwiniaStakingStructsRewardDestination,DarwiniaStakingStructsStakingBalance,DarwiniaStakingStructsValidatorPrefs,SpCoreChangesTrieChangesTrieConfiguration,DarwiniaVestingVestingInfo,DarwiniaRuntimeMessagesCrabMessageDarwiniaToCrabMessagesParameter } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    bridgeCrabMessages: {
       ...
       * event.
       **/
      updatePalletParameter: AugmentedSubmittable<(parameter: DarwiniaRuntimeMessagesCrabMessageDarwiniaToCrabMessagesParameter | { CrabToDarwiniaConversionRate: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [DarwiniaRuntimeMessagesCrabMessageDarwiniaToCrabMessagesParameter]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
