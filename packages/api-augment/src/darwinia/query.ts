...
import type { FrameSupportWeightsPerDispatchClassU64, FrameSystemAccountInfo, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, PalletAuthorshipUncleEntryItem, PalletBountiesBounty, PalletCollectiveVotes, PalletElectionProviderMultiPhasePhase, PalletElectionProviderMultiPhaseReadySolution, PalletElectionProviderMultiPhaseRoundSnapshot, PalletElectionProviderMultiPhaseSignedSignedSubmission, PalletElectionProviderMultiPhaseSolutionOrSnapshotSize, PalletGrandpaStoredPendingChange, PalletGrandpaStoredState, PalletIdentityRegistrarInfo, PalletIdentityRegistration, PalletImOnlineBoundedOpaqueNetworkState, PalletImOnlineSr25519AppSr25519Public, PalletMultisigMultisig, PalletProxyAnnouncement, PalletProxyProxyDefinition, PalletRecoveryActiveRecovery, PalletRecoveryRecoveryConfig, PalletSocietyBid, PalletSocietyBidKind, PalletSocietyVote, PalletSocietyVouchingStatus, PalletTipsOpenTip, PalletTransactionPaymentReleases, PalletTreasuryProposal, SpConsensusBabeAppPublic, SpConsensusBabeBabeEpochConfiguration, SpConsensusBabeDigestsNextConfigDescriptor, SpCoreCryptoKeyTypeId, SpRuntimeDigest, SpRuntimeHeader, SpStakingOffenceOffenceDetails,DarwiniaCommonRuntimeImplsAccountData, DarwiniaBalancesReserveData,DarwiniaBalancesReleases,
  BpHeaderChainAuthoritySet,BpMessagesInboundLaneData,BpMessagesOutboundLaneData,BpMessagesMessageKey,BpMessagesMessageData,BpMessagesOperatingMode,DarwiniaDemocracyReferendumInfo,DarwiniaDemocracyPreimageStatus,DarwiniaDemocracyReleases,DarwiniaDemocracyVoteVoting,DarwiniaBridgeEthereumEthereumRelayHeaderParcel,DarwiniaRelayPrimitivesRelayAuthoritiesRelayAuthority,DarwiniaRelayPrimitivesRelayerGameRelayVotingState,DarwiniaRelayPrimitivesRelayAuthoritiesMmrRootToSign,DarwiniaRelayPrimitivesRelayAuthoritiesScheduledAuthoritiesChange,
  DarwiniaRelayPrimitivesRelayerGameRelayAffirmation,DpFeeRelayer,DpFeeOrder,
  DarwiniaElectionsPhragmenSeatHolder,DarwiniaElectionsPhragmenVoter,
  PalletSchedulerReleases,PalletSchedulerScheduledV2,DarwiniaRuntimePalletsSessionSessionKeys,
  DarwiniaStakingStructsActiveEraInfo,DarwiniaStakingStructsExposure,DarwiniaStakingStructsEraRewardPoints,DarwiniaStakingStructsForcing,DarwiniaStakingStructsValidatorPrefs,DarwiniaStakingStructsStakingLedger,DarwiniaStakingStructsNominations,DarwiniaStakingSlashingSlashingSpans,DarwiniaStakingSlashingSpanRecord,DarwiniaStakingSlashingRk,DarwiniaStakingStructsRewardDestination,DarwiniaStakingStructsReleases,DarwiniaStakingStructsUnappliedSlash,DarwiniaVestingReleases,DarwiniaVestingVestingInfo,
  DarwiniaSupportStructsBalanceLock} from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/storage' {
  export interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    feeMarket: {
      assignedRelayers: AugmentedQuery<ApiType, () => Observable<Option<Vec<DpFeeRelayer>>>, []> & QueryableStorageEntry<ApiType, []>;
      ...
      orders: AugmentedQuery<ApiType, (arg: ITuple<[U8aFixed, u64]> | [U8aFixed | string | Uint8Array, u64 | AnyNumber | Uint8Array]) => Observable<Option<DpFeeOrder>>, [ITuple<[U8aFixed, u64]>]> & QueryableStorageEntry<ApiType, [ITuple<[U8aFixed, u64]>]>;
      relayers: AugmentedQuery<ApiType, () => Observable<Vec<AccountId32>>, []> & QueryableStorageEntry<ApiType, []>;
      relayersMap: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<DpFeeRelayer>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
