...
import type { BpMessagesDeliveredMessages, DarwiniaEcdsaAuthorityPrimitivesCommitment, DarwiniaEcdsaAuthorityPrimitivesOperation, DarwiniaRuntimeBridgesMessageCrabDarwiniaToCrabMessagesParameter, DarwiniaRuntimePalletsProxyProxyType, DarwiniaStakingStructsExposure, DpAssetTokenMetadata, DpRelayerGameRelayAffirmationId, EthereumLog, EthereumPrimitivesHeader, EthereumPrimitivesReceiptTypedReceipt, EvmCoreErrorExitReason, FrameSupportTokensMiscBalanceStatus, FrameSupportWeightsDispatchInfo, PalletDemocracyVoteThreshold, PalletElectionProviderMultiPhaseElectionCompute, PalletFeeMarketS2sPaymentRewardItem, PalletFeeMarketSlashReport, PalletImOnlineSr25519AppSr25519Public, PalletMultisigTimepoint, SpCoreEcdsaSignature, SpFinalityGrandpaAppPublic, SpRuntimeDispatchError, SpRuntimeTransactionValidityTransactionValidityError } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    proxy: {
       ...
       **/
      AnonymousCreated: AugmentedEvent<ApiType, [anonymous: AccountId32, who: AccountId32, proxyType: DarwiniaRuntimePalletsProxyProxyType, disambiguationIndex: u16], { anonymous: AccountId32, who: AccountId32, proxyType: DarwiniaRuntimePalletsProxyProxyType, disambiguationIndex: u16 }>;
      /**
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: DarwiniaRuntimePalletsProxyProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: DarwiniaRuntimePalletsProxyProxyType, delay: u32 }>;
      /**
