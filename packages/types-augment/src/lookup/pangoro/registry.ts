...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    DarwiniaBridgeBscCall: DarwiniaBridgeBscCall;
    DarwiniaBridgeBscError: DarwiniaBridgeBscError;
