...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    EthereumHeaderBrief: EthereumHeaderBrief;
    'Option<EthereumHeaderBrief>': Option<EthereumHeaderBrief>;
    'Vec<EthereumHeaderBrief>': Vec<EthereumHeaderBrief>;
    ...
    EthereumHeaderThingWithProof: EthereumHeaderThingWithProof;
    'Option<EthereumHeaderThingWithProof>': Option<EthereumHeaderThingWithProof>;
    'Vec<EthereumHeaderThingWithProof>': Vec<EthereumHeaderThingWithProof>;
    ConfirmedEthereumHeaderInfo: ConfirmedEthereumHeaderInfo;
    'Option<ConfirmedEthereumHeaderInfo>': Option<ConfirmedEthereumHeaderInfo>;
    'Vec<ConfirmedEthereumHeaderInfo>': Vec<ConfirmedEthereumHeaderInfo>;
    EthereumHeaderThing: EthereumHeaderThing;
    'Option<EthereumHeaderThing>': Option<EthereumHeaderThing>;
    'Vec<EthereumHeaderThing>': Vec<EthereumHeaderThing>;
    ...
    'Option<EthReceiptProof>': Option<EthReceiptProof>;
    'Vec<EthReceiptProof>': Vec<EthReceiptProof>;
    ...
    Round: Round;
    'Compact<Round>': Compact<Round>;
    'Option<Round>': Option<Round>;
    'Vec<Round>': Vec<Round>;
    TcHeaderThingWithProof: TcHeaderThingWithProof;
    'Option<TcHeaderThingWithProof>': Option<TcHeaderThingWithProof>;
    'Vec<TcHeaderThingWithProof>': Vec<TcHeaderThingWithProof>;
    TcHeaderThing: TcHeaderThing;
    'Option<TcHeaderThing>': Option<TcHeaderThing>;
    'Vec<TcHeaderThing>': Vec<TcHeaderThing>;
    TcBlockNumber: TcBlockNumber;
    'Compact<TcBlockNumber>': Compact<TcBlockNumber>;
    'Option<TcBlockNumber>': Option<TcBlockNumber>;
    'Vec<TcBlockNumber>': Vec<TcBlockNumber>;
    TcHeaderHash: TcHeaderHash;
    'Option<TcHeaderHash>': Option<TcHeaderHash>;
    'Vec<TcHeaderHash>': Vec<TcHeaderHash>;
    GameId: GameId;
    'Option<GameId>': Option<GameId>;
    'Vec<GameId>': Vec<GameId>;
    RelayProposalT: RelayProposalT;
    'Option<RelayProposalT>': Option<RelayProposalT>;
    'Vec<RelayProposalT>': Vec<RelayProposalT>;
