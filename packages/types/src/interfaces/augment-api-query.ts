...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    balances: {
       ...
       **/
      account: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<BalanceInfo>> & QueryableStorageEntry<ApiType>;
      /**
    ...
    staking: {
       ...
       **/
      erasStakers: AugmentedQueryDoubleMap<ApiType, (key1: EraIndex | AnyNumber | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<ExposureT>> & QueryableStorageEntry<ApiType>;
      /**
       ...
       * If stakers hasn't been set or has been removed then empty exposure is returned.
       **/
      erasStakersClipped: AugmentedQueryDoubleMap<ApiType, (key1: EraIndex | AnyNumber | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<ExposureT>> & QueryableStorageEntry<ApiType>;
      /**
       ...
       **/
      erasTotalStake: AugmentedQuery<ApiType, (arg: EraIndex | AnyNumber | Uint8Array) => Observable<Power>> & QueryableStorageEntry<ApiType>;
      /**
       ...
       **/
      erasValidatorReward: AugmentedQuery<ApiType, (arg: EraIndex | AnyNumber | Uint8Array) => Observable<Option<RingBalance>>> & QueryableStorageEntry<ApiType>;
      /**
       * Mode of era forcing.
       **/
       ...
       **/
      nominatorSlashInEra: AugmentedQueryDoubleMap<ApiType, (key1: EraIndex | AnyNumber | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<Option<RKT>>> & QueryableStorageEntry<ApiType>;
      /**
       ...
       **/
      validatorSlashInEra: AugmentedQueryDoubleMap<ApiType, (key1: EraIndex | AnyNumber | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<Option<ITuple<[Perbill, RKT]>>>> & QueryableStorageEntry<ApiType>;
    };
    sudo: {
      [key: string]: QueryableStorageEntry<ApiType>;
      /**
