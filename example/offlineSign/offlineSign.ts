 ...
 */
 ...
 import { construct, decode, deriveAddress, getRegistry, methods } from './index';
 ...
 async function main(): Promise<void> {
   ...
   const alice = keyring.addFromUri('*** mnemonic  ***', { name: 'Alice' }, 'sr25519');
   console.log(
     "Alice's SS58-Encoded Address:",
     deriveAddress(alice.publicKey, 18) // TODO, use correct prefix
   );
   ...
   const unsigned = methods.balances.transfer(
     {
       value: '123456789',
       dest: '2qMskW9mrrdUcFS5s7a3Pq5PxoTa1NTirDEggPUNmaCEJ5Ch', // Bob
     },
     {
       address: deriveAddress(alice.publicKey, 18), // TODO, use correct prefix
       blockHash,
       ...
       genesisHash,
       metadataRpc,
       nonce: 8, // Assuming this is Alice's first tx on the chain
       specVersion,
       tip: 0,
       transactionVersion,
     },
